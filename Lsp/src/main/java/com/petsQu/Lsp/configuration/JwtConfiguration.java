package com.petsQu.Lsp.configuration;

import com.petsQu.Lsp.filter.JwtAuthenticationFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
      /* http.csrf().disable()
        ...
        http.csrf().disable()
                .cors().disable()
                .authorizeRequests()
                .antMatchers("/api/user/*").permitAll() // allow this endpoint without authentication
